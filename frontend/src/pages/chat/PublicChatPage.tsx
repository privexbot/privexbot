...
export function PublicChatPage() {
  ...
  // Mirrors the LeadCaptureForm visual language (rounded-2xl card, manrope
  // typography, design-token grays + dark-mode variants, dynamic primaryColor
  // accent on input focus + submit button) so the two surfaces feel cohesive.
  if (authRequired) {
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
        <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          <div className="flex flex-col items-center mb-6">
            ...
            <h1 className="text-xl font-semibold text-gray-900 dark:text-gray-50 font-manrope">{chatConfig.name}</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 font-manrope">This chatbot requires authentication</p>
          </div>

          <div className="space-y-4">
            <div>
              <label htmlFor="apiKey" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2 font-manrope">
                API Key
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-50 placeholder-gray-400 dark:placeholder-gray-500 font-manrope rounded-xl focus:outline-none focus:ring-2 focus:border-transparent"
                  style={{ '--tw-ring-color': primaryColor } as React.CSSProperties}
                  disabled={authenticating}
                />
              </div>
              {authError && (
                <p className="mt-2 text-sm text-red-600 dark:text-red-400 font-manrope flex items-center gap-1">
            ...
            <p className="text-xs text-center text-gray-500 dark:text-gray-400 font-manrope">
