      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="font-manrope text-lg md:text-xl lg:text-xl xl:text-2xl text-white/90 mb-10 lg:mb-16 max-w-4xl mx-auto leading-relaxed">
              Free forever — no credit card required. Open source, self-host or use the hosted version.
            </p>
            ...
            <div className="space-y-4 lg:space-y-0 lg:flex lg:items-center lg:justify-center lg:gap-6">
              ...
              <Link to="/signup" className="block lg:inline-block">
                <Button
                  className="font-manrope w-full lg:w-[140px] h-[44px] bg-white hover:bg-gray-100 text-black font-semibold text-sm px-6 py-2 rounded-xl border-b-[3px] border-gray-300 hover:border-gray-400 transition-all duration-200 hover:scale-105 shadow-lg gap-1"
                >
                  Start free
                </Button>
              </Link>
              ...
              >
                <Button
                  variant="outline"
                  className="font-manrope w-full lg:w-[140px] h-[44px] bg-gray-900/80 hover:bg-gray-800/90 text-white border-gray-700 hover:border-gray-600 font-semibold text-sm px-6 py-2 rounded-xl border-b-[3px] border-gray-800 hover:border-gray-700 transition-all duration-200 hover:scale-105 backdrop-blur-sm gap-1"
                >
                  View on GitHub
                </Button>
              </a>
